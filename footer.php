    ...
    <div class="footer-top section">
      <div class="container">
        ...
        <li>
          <a href="#" class="footer-link">
            ...
            <span class="footer-link-text">Mitt Konto</span>
          </a>
        </li>
        ...
        <li>
          <a href="#" class="footer-link">
            ...
            <span class="footer-link-text">Visa Kundvagn</span>
          </a>
        </li>
        ...
        <li>
          <a href="#" class="footer-link">
            ...
            <span class="footer-link-text">Önskelista</span>
          </a>
        </li>
      ...
      <div class="footer-list">
        ...
        <form action="" class="newsletter-form">
          <input type="email" name="email" required placeholder="E-postadress" class="newsletter-input">
